...
### STL организаторов не включены в репозиторий

11 из 16 тестовых объектов — оригинальные STL, полученные от организаторов
(`01 Sources/Stl` в рабочей wiki задачи), и намеренно **не публикуются** в
этом репозитории. В сборке остаются только 5 синтетических пограничных
...
Для полного запуска (все 16 объектов, оба демо) организаторам нужно положить
свои оригинальные файлы по трём путям (везде одинаковый набор из 11 файлов):
...
(пункты 2-4 используют STL организаторов — см. «STL организаторов не
включены в репозиторий» выше, недоступны без них)
...
- **Открытый вопрос — смягчение падения товара в ролл-кейдж.** Высота
  ...
  не выбрано — правильный вариант зависит от того, какие ролл-кейджи
  организаторы уже закупили и используют массово — под них и стоит
  проектировать смягчение, а не выбирать вслепую. Рассматриваемые
