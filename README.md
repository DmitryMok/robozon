...
Что к какой части решения относится (см. требование организаторов об
описании структуры):
...
Версии ПО: протестировано на Ubuntu 24.04 LTS, Webots R2025a, Python ≥ 3.10.
Для необязательного GPU-пути (см. ниже) — NVIDIA-драйвер с поддержкой
CUDA 12.1+.
...
### Если хотите включить GPU-путь (необязательно)
