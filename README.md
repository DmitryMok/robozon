...
- Пограничные случаи по габаритам тоже консервативны: ошибка измерения
  (до ~3% на 9 ракурсах, до ~2.8% на 15) закладывается в решение — объект
  на границе габаритного порога уходит в накопитель, а не рискованно
  классифицируется автоматически.
