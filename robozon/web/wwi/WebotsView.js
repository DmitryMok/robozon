...
export default class WebotsView extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.progressCss.href = '/wwi/css/progress.css';
  ...
  #init() {
    ...
    promises.push(this.#loadScript('/wwi/dependencies/ansi_up.js'));
    promises.push(this.#loadScript('/wwi/dependencies/assimpjs.js'));
    promises.push(this.#loadScript('/wwi/dependencies/glm-js.min.js'));
    promises.push(this.#loadScript('/wwi/dependencies/quaternion.min.js'));
    promises.push(this.#loadScript('/wwi/dependencies/libtess.min.js'));
    promises.push(this.#loadScript('/wwi/enum.js'));
